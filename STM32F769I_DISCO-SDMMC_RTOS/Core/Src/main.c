...
int main(void)
{
	...
	xTaskCreate(StartDefaultTask, "DefaultTask", 560, NULL, 5,
			&DefaultTaskHandle);

	/* creation of mountSDMMCTask */
	xTaskCreate(StartmountSDMMCTask, "mountSDMMCTask", 560, NULL, 5,
			&mountSDMMCTaskHandle);

	/* creation of readSDCardTask */
	xTaskCreate(StartreadSDCardTask, "readSDCardTask", 560, NULL, 5,
			&readSDCardTaskHandle);

	/* creation of writeSDCardTask */
	xTaskCreate(StartwriteSDCardTask, "writeSDCardTask", 560, NULL, 5,
			&writeSDCardTaskHandle);

	/* creation of SDFileOperation */
	xTaskCreate(StartSDFileOperationTask, "SDFileOperationTask", 560, NULL, 5,
			&SDFileOperationHandle);
