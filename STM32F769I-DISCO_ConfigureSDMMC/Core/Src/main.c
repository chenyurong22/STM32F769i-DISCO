...
/* Definitions for mountSDMMC2 */
osThreadId_t mountSDMMC2Handle;
const osThreadAttr_t mountSDMMC2_attributes = {
  .name = "mountSDMMC2",
  .stack_size = 560 * 4,
  .priority = (osPriority_t) osPriorityNormal2,
};
/* Definitions for writeSDMMC2 */
osThreadId_t writeSDMMC2Handle;
const osThreadAttr_t writeSDMMC2_attributes = {
  .name = "writeSDMMC2",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityNormal3,
};
/* Definitions for readSDMMC2 */
osThreadId_t readSDMMC2Handle;
const osThreadAttr_t readSDMMC2_attributes = {
  .name = "readSDMMC2",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityNormal4,
};
/* Definitions for logSyncMutex */
osMutexId_t logSyncMutexHandle;
const osMutexAttr_t logSyncMutex_attributes = {
  .name = "logSyncMutex"
};
/* USER CODE BEGIN PV */
...
void StartmountSDMMC2(void *argument);
void StartwriteSDMMC2(void *argument);
void StartreadSDMMC2(void *argument);
...
//	writeFormatData(&huart1, "File size: %5d Byte \r\n",fileSize(pOutFilename));
  ...
  osKernelInitialize();
  /* Create the mutex(es) */
  /* creation of logSyncMutex */
  logSyncMutexHandle = osMutexNew(&logSyncMutex_attributes);
  ...
  /* creation of mountSDMMC2 */
  mountSDMMC2Handle = osThreadNew(StartmountSDMMC2, NULL, &mountSDMMC2_attributes);

  /* creation of writeSDMMC2 */
  writeSDMMC2Handle = osThreadNew(StartwriteSDMMC2, NULL, &writeSDMMC2_attributes);

  /* creation of readSDMMC2 */
  readSDMMC2Handle = osThreadNew(StartreadSDMMC2, NULL, &readSDMMC2_attributes);
...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_SAI2|RCC_PERIPHCLK_SDMMC2
                              |RCC_PERIPHCLK_CLK48;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : NC4_Pin NC5_Pin PI15 LCD_BL_CTRL_Pin */
  GPIO_InitStruct.Pin = NC4_Pin|NC5_Pin|GPIO_PIN_15|LCD_BL_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
...
/* USER CODE BEGIN Header_StartmountSDMMC2 */
/**
 * @brief Function implementing the mountSDMMC2 thread.
 * @param argument: Not used
 * @retval None
 */
/* USER CODE END Header_StartmountSDMMC2 */
void StartmountSDMMC2(void *argument)
{
  /* USER CODE BEGIN StartmountSDMMC2 */
	/* Infinite loop */
	for (;;)
	{
  ...
  /* USER CODE END StartmountSDMMC2 */
}

/* USER CODE BEGIN Header_StartwriteSDMMC2 */
/**
 * @brief Function implementing the writeSDMMC2 thread.
 * @param argument: Not used
 * @retval None
 */
/* USER CODE END Header_StartwriteSDMMC2 */
void StartwriteSDMMC2(void *argument)
{
  /* USER CODE BEGIN StartwriteSDMMC2 */
	/* Infinite loop */
	for (;;)
	{
  ...
  /* USER CODE END StartwriteSDMMC2 */
}

/* USER CODE BEGIN Header_StartreadSDMMC2 */
/**
 * @brief Function implementing the readSDMMC2 thread.
 * @param argument: Not used
 * @retval None
 */
/* USER CODE END Header_StartreadSDMMC2 */
void StartreadSDMMC2(void *argument)
{
  /* USER CODE BEGIN StartreadSDMMC2 */
	/* Infinite loop */
	for (;;)
	{
